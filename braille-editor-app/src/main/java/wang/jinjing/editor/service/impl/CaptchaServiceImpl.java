...
import wang.jinjing.common.exception.CaptchaServiceException;
...
public class CaptchaServiceImpl implements CaptchaService {
    ...
    public CaptchaResultVO getCaptchaImage() {
        // 获取新的UUID
        String verifyKey = CAPTCHA_KEY_PREFIX + "::" + UUID.randomUUID().toString();
    ...
    public boolean verifyCaptcha(@Valid String captchaCode, String uuid) {
        String verifyRedisKey = "captcha_code:" + uuid;
